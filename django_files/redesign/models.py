...
class Country(models.Model):
	...
	def __unicode__(self):
		return "%s, %s" % (self.name,self.capital_city)
...
# These tables answer questions falling under CASY & CSAY
# What does C export?
# Who exports product P?
...
# These tables answer questions falling under CSAY, CCSY, CSPY
# Where does C export? 
# What does C export to C?
# Where does C export P?
